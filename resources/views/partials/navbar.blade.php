<nav class="site-nav" id="siteNavbar">
    ...
    <img src="{{ asset('images/logo.png') }}" alt="BioAqua Lab" class="site-brand-icon">
    <span class="site-brand-text">BioAqua Lab</span>
        ...
        <div class="site-nav-right">
            ...
            <ul class="site-nav-menu">
                ...
                @auth
                    @if(auth()->user()->role === 'admin')
                        <li><a href="{{ route('barang.index') }}" class="nav-link {{ request()->is('barang*') ? 'active' : '' }}">Produk</a></li>
                        <li><a href="{{ route('admin.pesanan') }}" class="nav-link {{ request()->is('admin/pesanan') ? 'active' : '' }}">Pesanan</a></li>
                    @else
                        <li><a href="{{ url('/#produk') }}" class="nav-link {{ request()->is('produk') ? 'active' : '' }}">Produk</a></li>
                        <li><a href="{{ route('pesanan.riwayat') }}" class="nav-link {{ request()->is('riwayat') || request()->is('pesanan*') ? 'active' : '' }}">Pesanan</a></li>
                    @endif
                @else
                    <li><a href="{{ url('/#produk') }}" class="nav-link {{ request()->is('produk') ? 'active' : '' }}">Produk</a></li>
                @endauth
            ...
            @else
                <a href="{{ route('login') }}" class="user-avatar-btn" title="Login" aria-label="Login">
                    <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7" fill-rule="evenodd"/></svg>
                </a>
            @endauth
