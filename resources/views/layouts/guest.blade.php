<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="{{ Cookie::get('tema') === 'dark' ? 'dark-mode' : '' }}">
    <head>
        <meta charset="utf-8">
        ...
        <title>BioAqua Lab - {{ config('app.name', 'Laravel') }}</title>
    ...
    <body>
        <div class="guest-wrapper">
            <div class="guest-logo">
                <a href="{{ url('/') }}">
                    <img src="{{ asset('images/logo.png') }}" alt="BioAqua Lab" class="logo-icon">
            ...
            <p class="guest-footer-text">© {{ date('Y') }} BioAqua Lab. Semua hak dilindungi.</p>
        </div>
