...
<div class="co-wrap">
  ...
  <form action="{{ route('pesanan.store') }}" method="POST" id="checkoutForm" enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="items" id="itemsInput">

    @error('items')
    <div class="co-card" style="border-color:#fca5a5;background:#fef2f2;color:#991b1b;font-size:.85rem;font-weight:600;margin-bottom:16px;">
      ⚠️ {{ $message }}
    </div>
    @enderror
        ...
        <div class="co-card">
          ...
          <div class="fg-row">
            <div class="fg">
              ...
              <input name="nama_pelanggan" value="{{ auth()->user()->name }}" class="inp" placeholder="Nama penerima" required>
            ...
            <div class="fg">
              ...
              @error('no_hp')<p class="err">{{ $message }}</p>@enderror
            </div>
          </div>
        ...
        <div class="co-card">
          ...
          <div id="alamatBlock">
            ...
            <div class="fg">
              ...
              @error('kecamatan')<p class="err">{{ $message }}</p>@enderror
            </div>
            <div class="fg" style="margin-top:12px">
              ...
              @error('kelurahan')<p class="err">{{ $message }}</p>@enderror
            </div>
            <div class="fg-row" style="margin-top:12px">
              <div class="fg">
                ...
                @error('rt_rw')<p class="err">{{ $message }}</p>@enderror
              </div>
            </div>
            <div class="fg" style="margin-top:12px">
        ...
        <div class="co-sticky">
          ...
          <div class="co-card">
            ...
            <div id="paymentDetail" class="payment-detail-box">
              ...
              <div id="qrisImageWrap" style="display:none;text-align:center;margin-top:12px;">
                <img id="qrisImage" src="https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=BIOAQUA-LAB-QRIS-PAYMENT" alt="QRIS Code" style="width:200px;height:200px;border-radius:12px;background:#fff;padding:8px;">
                <p style="font-size:.75rem;margin:8px 0 0;opacity:.85;">Scan kode QR di atas menggunakan aplikasi e-wallet/m-banking apapun</p>
              </div>
            </div>

            {{-- Upload Bukti Bayar (muncul kecuali COD) --}}
            <div id="buktiBlock" class="bukti-block">
              ...
              @error('bukti_bayar')<p class="err">{{ $message }}</p>@enderror
            </div>
...
/* ===== DARK MODE OVERRIDES ===== */
html.dark-mode .co-card,
html.dark-mode .inp,
html.dark-mode .summary-box,
html.dark-mode .dlv-inner,
html.dark-mode .pay-inner,
html.dark-mode .bukti-dropzone { background:#16213e !important; border-color:#334155 !important; }
html.dark-mode .co-card-head h3,
html.dark-mode .dlv-title,
html.dark-mode .pay-name,
html.dark-mode .bukti-label,
html.dark-mode .summary-total,
html.dark-mode .co-item-name { color:#f1f5f9 !important; }
html.dark-mode .lbl,
html.dark-mode .pay-group-lbl { color:#cbd5e1 !important; }
html.dark-mode .inp { color:#f1f5f9 !important; }
html.dark-mode .dlv-sub,
html.dark-mode .pay-sub,
html.dark-mode .empty-cart,
html.dark-mode .bukti-hint2,
html.dark-mode .bukti-note,
html.dark-mode .secure-note,
html.dark-mode .co-item-cat,
html.dark-mode .co-item-qty,
html.dark-mode .summary-row { color:#94a3b8 !important; }
html.dark-mode .dlv-card.selected .dlv-inner,
html.dark-mode .pay-card.selected .pay-inner { background:#1e3a5f !important; }
html.dark-mode .alamat-divider { background:#1e3a5f !important; color:#7dd3fc !important; }
html.dark-mode .co-item-price,
html.dark-mode .co-total-bar strong { color:#7dd3fc !important; }
html.dark-mode .summary-total strong { color:#7dd3fc !important; }
html.dark-mode .bukti-hint { color:#7dd3fc !important; }
html.dark-mode .pay-group-lbl { border-color:#334155 !important; }
</style>
...
const paymentInstructions = {
  qris: {
    title: 'QRIS',
    detail: '<strong>Scan QR Code di bawah ini:</strong>Bisa dibayar via GoPay, OVO, Dana, ShopeePay, dan semua e-wallet/m-banking yang mendukung QRIS.',
  },
  transfer_bca: {
    title: 'Transfer BCA',
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function updatePayment(method) {
    ...
    document.getElementById('pdAmount').textContent = fmt(total);
    document.getElementById('qrisImageWrap').style.display = (method === 'qris') ? 'block' : 'none';
