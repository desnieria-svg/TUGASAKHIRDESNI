            ...
            <div class="metode-cell">
              ...
              <?php if(!$isCod): ?>
                <?php if($p->bukti_bayar): ?>
                  <a href="<?php echo e(Storage::url($p->bukti_bayar)); ?>" target="_blank" class="bukti-link">🖼 Lihat Bukti</a>
...
.stat-card { background:#fff; border:2px solid #dbeafe; border-radius:16px; padding:20px 16px; text-align:center; transition:.2s; box-shadow:0 4px 16px rgba(37,99,235,.07); position:relative; overflow:hidden; }
...
.stat-val  { font-size:1.75rem; font-weight:900; color:#0f172a; margin-bottom:4px; line-height:1; font-family:'Inter',system-ui,sans-serif; }
.stat-lbl  { font-size:.74rem; color:#64748b; font-weight:600; letter-spacing:.02em; }
.stat-income { font-size:1.05rem; font-weight:900; color:#1e40af; word-break:break-word; line-height:1.2; }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\BioAquaLab\bioaqua\resources\views/pesanan/admin.blade.php ENDPATH**/ ?>