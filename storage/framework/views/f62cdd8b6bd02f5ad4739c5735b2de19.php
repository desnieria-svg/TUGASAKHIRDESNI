...
@keyframes modalPop {
  ...
  <div class="admin-home-section">
      <div class="dashboard-header" style="margin:24px 0 16px;">
          ...
          <h1 style="font-size:1.5rem;font-weight:800;color:#0f172a;margin-bottom:4px;">Halo, <?php echo e(auth()->user()->name); ?>! 👋</h1>
...
<?php endif; ?>
      ...
      <div class="admin-chart-card">
          ...
          <?php $__empty_1 = true; $__currentLoopData = $kategoriStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <?php
                  $labelKat = ['galon'=>'Air Galon','botol'=>'Air Botol','jerigen'=>'Air Jerigen','cup'=>'Air Cup'][$k['kategori']] ?? ucfirst($k['kategori']);
              ?>
              <div class="admin-bar-row">
                  <span class="admin-bar-label"><?php echo e($labelKat); ?></span>
                  <div class="admin-bar-track">
                      <div class="admin-bar-fill" style="width:<?php echo e($k['persen']); ?>%;"></div>
                  </div>
                  <span class="admin-bar-val"><?php echo e($k['total_stok']); ?></span>
              </div>
      ...
      <div class="admin-chart-card">
          ...
          <table class="data-table" style="width:100%;">
              ...
              <tbody>
                  <?php $__empty_1 = true; $__currentLoopData = $pesananTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                      <tr>
                          <td style="font-weight:600"><?php echo e($p->nama_pelanggan); ?></td>
                          <td><?php echo e($p->nama_produk); ?></td>
                          <td style="font-weight:bold;color:#2563eb">Rp <?php echo e(number_format($p->total_harga, 0, ',', '.')); ?></td>
                          <td><span class="status <?php echo e($p->status); ?>"><?php echo e(strtoupper($p->status)); ?></span></td>
                      </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
          ...
          <div style="margin-top:14px;text-align:right;">
              <a href="<?php echo e(route('admin.pesanan')); ?>" style="font-size:0.85rem;font-weight:700;color:#0284c7;text-decoration:none;">Lihat semua pesanan →</a>
          </div>
      </div>
        ...
        <main class="produk-grid" id="produkGrid">
          ...
          <?php $__empty_1 = true; $__currentLoopData = $barang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <article class="product-card"
              ...
              <?php elseif($item->jumlah <= 5 && auth()->check() && auth()->user()->role === 'admin'): ?>
                ...
                <div class="card-footer">
                  ...
                  <?php if($item->jumlah > 0): ?>
                    <button class="btn btn-primary btn-sm"
                      onclick="tambahKeranjang(this, '<?php echo e(addslashes($item->nama)); ?>', <?php echo e($item->harga); ?>, '<?php echo e($ikon); ?>', <?php echo e($item->id); ?>, '<?php echo e($item->kategori); ?>', '<?php echo e($fotoUrl ?? ''); ?>', <?php echo e($item->jumlah); ?>)">
                      + Pesan
                    </button>
                  <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\BioAquaLab\BioAquaLab\resources\views/pages/home.blade.php ENDPATH**/ ?>