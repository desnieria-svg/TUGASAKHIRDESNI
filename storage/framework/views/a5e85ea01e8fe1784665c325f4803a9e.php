  ...
  <div class="rw-tbl-card">
    ...
    <table class="rw-tbl">
      ...
      <tbody>
        ...
        ?>
        <tr>
          <td><span class="rw-kode"><?php echo e($p->kode_pesanan ?? '#'.$p->id); ?></span></td>
          <td class="rw-tgl"><?php echo e(\Carbon\Carbon::parse($p->tanggal_pesan)->format('d M Y')); ?></td>
          <td class="rw-prod" title="<?php echo e($p->nama_produk); ?>"><?php echo e($p->nama_produk); ?></td>
          <td class="rw-total">Rp <?php echo e(number_format($p->total_harga,0,',','.')); ?></td>
          <td><span class="rw-metode"><?php echo e(strtoupper(str_replace('_',' ',$p->metode_bayar ?? '-'))); ?></span></td>
          <td><span class="rw-status" style="background:<?php echo e($sbg); ?>;color:<?php echo e($sc); ?>;"><?php echo e($sicon); ?> <?php echo e(ucfirst($p->status)); ?></span></td>
          <td><a href="<?php echo e(route('pesanan.show',$p)); ?>" class="rw-detail-btn">Lihat Detail →</a></td>
        </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\BioAquaLab\BioAquaLab\resources\views/pesanan/riwayat.blade.php ENDPATH**/ ?>