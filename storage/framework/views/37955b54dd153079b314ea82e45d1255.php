  ...
  <div class="show-grid">
    <div class="show-card">
      ...
      <div class="pay-status-section">
        ...
        <?php else: ?>
          <div class="pay-status-badge wait">⏳ Menunggu konfirmasi admin (1×24 jam)</div>
        <?php endif; ?>

        <?php if($pesanan->bukti_bayar): ?>
        <a href="<?php echo e(Storage::url($pesanan->bukti_bayar)); ?>" target="_blank" class="bukti-view-btn">🖼 Lihat Bukti Pembayaran</a>
        <?php endif; ?>
      </div>
      <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\BioAquaLab\bioaqua\resources\views/pesanan/show.blade.php ENDPATH**/ ?>