...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Barang>|Barang whereFoto($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Barang>|Barang whereUserId($value)
     ...
     * @property mixed $jenis_pengiriman
     * @property string|null $catatan
     * @property string $konfirmasi_bayar
     ...
     * @property string|null $kode_pesanan
     * @property int $id
     * @property-read \App\Models\User $user
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereKodePesanan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereMidtransOrderId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereMidtransToken($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereUserId($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereMetodeBayar($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereBuktiBayar($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereKonfirmasiBayar($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereCatatan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereJenisPengiriman($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereKecamatan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereKelurahan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereRtRw($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan proses() {@see App\Models\Pesanan::scopeProses()}
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan selesai() {@see App\Models\Pesanan::scopeSelesai()}
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan batal() {@see App\Models\Pesanan::scopeBatal()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
